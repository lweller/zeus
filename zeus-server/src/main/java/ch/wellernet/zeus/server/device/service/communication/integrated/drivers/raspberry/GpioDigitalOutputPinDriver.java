...
public class GpioDigitalOutputPinDriver implements DeviceDriver {
	...
	/**
	 * @see ch.wellernet.zeus.server.drivers.raspberrypi.DeviceDriver#execute(ch.wellernet.zeus.server.device.model.Command)
	 */
	@Override
	...
	/**
	 * @see ch.wellernet.zeus.server.device.service.communication.integrated.drivers.DeviceDriver#init()
	 */
	@Override
	@PostConstruct
	public void init() {
